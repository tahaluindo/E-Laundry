        ...
        <section>
            <div>
                <div class="title-block">
                    <h1 class="title">Tambah pekerja</h1>
                    <p class='title-description'>Gunakan form dibawah untuk menambahkan pekerja baru kedalam aplikasi.</p>
                </div>
            </div>
        </section>
        <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title-body">
                                <h3 class="title">Tambah pekerja</h3>
                            </div>
                            <form action="{{ route('application.users.workers.store') }}" method="POST" style="margin-bottom: 0">
                                {{ csrf_field() }}
                                <section>
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control boxed" name="username" value="{{ old('username') }}" placeholder="Masukkan Username Pekerja">
                                                @error('username')
                                        ...
                                        <div class="col-sm-12 col-md-6 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control underlined" name="phone_number" value="{{ old('phone_number') }}" placeholder="Masukkan Nomor Telefon Pekerja">
                                                @error('phone_number')
                                                    <span class="has-error">
                                                        {{ $message }}
                                                    </span>
                                        ...
                                        <div class="col-sm-12 col-md-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control underlined" name="name" value="{{ old('name') }}" placeholder="Masukkan Nama Pekerja">
                                                @error('name')
                                                    <span class="has-error">
                                                        {{ $message }}
                                                    </span>
                                        ...
                                        <div class="col-sm-12 col-md-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="mail" class="form-control underlined" name="email" value="{{ old('email') }}" placeholder="Masukkan Email Pekerja">
                                                @error('email')
                                                    <span class="has-error">
                                                        {{ $message }}
                                                    </span>
                                        ...
                                        <div class="col-sm-12 col-md-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control underlined" name="address" placeholder="Masukkan Alamat Pekerja">{{ old('address') }}</textarea>
                                                @error('address')
                                                    <span class="has-error">
                                                        {{ $message }}
                                                    </span>
